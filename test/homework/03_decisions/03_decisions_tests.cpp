...
TEST_CASE("Test get grade using if")
{
	...
	REQUIRE(get_letter_grade_using_if(101) == "Number is out of range");
...
TEST_CASE("Test get grade using switch")
{
	...
	REQUIRE(get_letter_grade_using_switch(101) == "Number is out of range");
